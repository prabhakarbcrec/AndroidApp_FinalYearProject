...
public class dinesh2Activity extends AppCompatActivity implements View.OnClickListener {
    CardView call4,sms4,mail4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinesh2);
        ...
        call4 =  findViewById(R.id.dineshcall);
        sms4 =  findViewById(R.id.dineshsms);
        mail4 = findViewById(R.id.dineshmail);
        call4.setOnClickListener(this);
        sms4.setOnClickListener(this);
        ...
        ttsoobject=new TextToSpeech(dinesh2Activity.this, new TextToSpeech.OnInitListener() {
            @Override
